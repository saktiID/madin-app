...
export const CircleStackIcon = defineComponent({
    setup() {
        return () => (
            <svg
                xmlns="http://www.w3.org/2000/svg"
...
export const PreviousIcon = defineComponent({
    setup() {
        return () => (
            <svg
...
export const NextIcon = defineComponent({
    setup() {
        return () => (
            <svg
                class="w-3 h-3 rtl:rotate-180"
...
export const SpinnerSmall = defineComponent({
    setup() {
        return () => (
            <svg
...
export const SpinnerMedium = defineComponent({
    setup() {
        return () => (
            <svg
...
export const SpinnerLarge = defineComponent({
    setup() {
        return () => (
            <svg
